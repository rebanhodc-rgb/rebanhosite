    ...
    <footer className="bg-ink py-14 text-ivory">
      <div className="container-x grid gap-10 md:grid-cols-[1.2fr_1fr_1fr]">
        <div>
          ...
          <p className="subtitle mt-4 max-w-sm text-sm leading-6 text-ivory/65">A roupa fala por quem a veste. Moda com significado, fé sem rótulos e propósito real.</p>
        </div>
